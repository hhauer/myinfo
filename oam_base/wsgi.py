"""
WSGI config for PSU_MyInfo project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "PSU_MyInfo.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "PSU_MyInfo.settings")
